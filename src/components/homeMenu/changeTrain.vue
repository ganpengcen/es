...
<div>
  <p style="height: 35px;line-height: 35px;color: #00AAAA">
    ...
    <span style="float: right;margin-right: 10px" @click="changeTrain">修改</span>
  </p>
  <div class="main" style="font-size: 15px;overflow: auto;padding: 15px;">
    <van-cell-group>
      <van-field v-model="upform.Motif" label="培训主题"
                 placeholder="请输入内容"></van-field>
      <van-field v-model="upform.TrainLong" label="培训时长"
                 placeholder="请输入内容"></van-field>
      <van-field v-model="upform.TrainLong" label="培训日期">
      ...
      <van-field v-model="upform.Trainer" label="培训人"
                 placeholder="请输入内容"></van-field>
      <van-field v-model="upform.Content" label="内容"
                 placeholder="请输入内容"></van-field>
    </van-cell-group>
